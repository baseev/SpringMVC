...
public interface CustomerManager
{
    ...
    public static final String UPDATE       = "INSERT INTO customer(name, created) VALUES(?, ?)";
    public static final String DELETE       = "INSERT INTO customer(name, created) VALUES(?, ?)";
    public static final String SELECT       = "INSERT INTO customer(name, created) VALUES(?, ?)";
